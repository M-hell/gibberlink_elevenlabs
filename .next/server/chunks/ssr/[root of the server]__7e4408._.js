...
"[project]/src/utils/audioUtils.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const audioMessageEmitter = new __TURBOPACK__imported__module__$5b$externals$5d2f$events__$5b$external$5d$__$28$events$2c$__cjs$29$__["EventEmitter"]();
...
"[project]/src/components/ConvAI.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$audioUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/utils/audioUtils.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$audiomotion$2d$analyzer$2f$src$2f$audioMotion$2d$analyzer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/audiomotion-analyzer/src/audioMotion-analyzer.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function ConvAI() {
    ...
    const [agentType, setAgentType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(init_agent_type);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [latestUserMessage, setLatestUserMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const [sessionId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>`session_${Date.now()}_${Math.random().toString(36).slice(2)}`);
    const [llmChat, setLLMChat] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([
        {
            role: 'system',
            content: SYSTEM_MESSAGES[agentType]
        }
    ]);
    const [glMode, setGlMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isProcessingInput, setIsProcessingInput] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const audioMotionRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const handleMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(({ message, source })=>{
    ...
    const genMyNextMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (messages = llmChat)=>{
        try {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setMounted(true);
        const handleRecordingMessage = async (message)=>{
            ...
            try {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$audioUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendAudioMessage"])(nextMessage, agentType === 'inbound');
            } finally{
                setIsProcessingInput(false);
            }
        };
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$audioUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["audioMessageEmitter"].on('recordingMessage', handleRecordingMessage);
        return ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$audioUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["audioMessageEmitter"].off('recordingMessage', handleRecordingMessage);
        };
    }, [
        endConversation,
        genMyNextMessage,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (glMode && mounted) {
            const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$audioUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getcontext"])();
            if (!context) {
                console.log('no context exiting');
                return;
            }
            // Create global analyzer node if not exists
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$audioUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createAnalyserNode"])();
            const analyserNode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$audioUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAnalyserNode"])();
            if (!analyserNode) {
            ...
            if (!audioMotionRef.current) {
                ...
                if (!container) return;
                audioMotionRef.current = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$audiomotion$2d$analyzer$2f$src$2f$audioMotion$2d$analyzer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"](container, {
                    source: analyserNode,
                    height: 300,
                    mode: 6,
                    fillAlpha: 0.7,
            ...
            const conversation = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$11labs$2f$client$2f$dist$2f$lib$2e$modern$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Conversation"].startSession({
                ...
                onConnect: ()=>{
                    ...
                    if (agentType === 'inbound') {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$audioUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startRecording"])();
                    }
                },
                onDisconnect: ()=>{
                ...
                clientTools: {
                    gibbMode: async (params)=>{
                        ...
                        try {
                            ...
                            setConversation(null);
                            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$audioUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startRecording"])();
                            setLatestUserMessage(nextMessage);
                            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$audioUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendAudioMessage"])(nextMessage, agentType === 'inbound');
                        } catch (error) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    latestUserMessage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            !glMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])('orb', isSpeaking ? 'animate-orb' : conversation && 'animate-orb-slow', isConnected || glMode ? 'orb-active' : 'orb-inactive', agentType),
                                onClick: ()=>{
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ConvAI$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/components/ConvAI.tsx [app-ssr] (ecmascript)");
"use client";
;
;
function Home() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ConvAI$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ConvAI"], {}, void 0, false, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7e4408._.js.map